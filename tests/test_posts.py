...
def test_unauthorized_user_get_one(client, test_posts):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Pesto Pasta", "Green", False),
        ("Ice Tea", "For summer", True),
    ],
)
...
def test_delete_post_non_exist(authorized_client):
    res = authorized_client.delete("/posts/999999999999999")
    assert res.status_code == 404


def test_authorized_user_delete_other_user_post(authorized_client, test_posts):
